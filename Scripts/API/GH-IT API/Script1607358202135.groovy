...
sites = WS.sendRequest(findTestObject('API/Postman/GetHelp/TipWeb/GET GetSites', [('HHD_API_Url') : GlobalVariable.HHD_API_Url
...
tags = WS.sendRequest(findTestObject('API/Postman/GetHelp/TipWeb/GET GetTag', [('HHD_API_Url') : GlobalVariable.HHD_API_Url
